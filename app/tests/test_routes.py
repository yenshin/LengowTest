...
def test_failed_routes(api_client):
    # TEST missing query
    url = "/money/convert"
    query = InputQuery()
    ...
    # multiple word currencies src and dest with unmanaged typos
    ...
    # INFO: test with arg in wrong order
...
def test_success_routes(api_client):
    url = "/money/convert"
    query = InputQuery()
